"""Composio tool group mappings with WordPress and Wix support."""
...
TOOL_GROUP_DEFINITIONS = {
    ...
    "publishing": {
        ...
        "permission": "write",
        "agents": ["publishing", "wordpress_intelligence", "wix_intelligence"]
    },
    "analytics": {
        "tools": ANALYTICS_TOOLS,
        "description": "Analytics and performance tracking tools including WordPress and Wix analytics",
        "permission": "read",
        "agents": ["analytics", "optimisation", "wordpress_intelligence", "wix_intelligence"]
    }
}
...
def get_platform_agents() -> list:
    """Get all platform intelligence agents including WordPress and Wix."""
    return ["reddit_intelligence", "x_intelligence", "tiktok_intelligence", 
            "facebook_intelligence", "linkedin_intelligence", 
            "wordpress_intelligence", "wix_intelligence"]